...
@Service
public class DefaultUsuarioService implements UserDetailsService, UsuarioService {

    private Logger logger = LoggerFactory.getLogger(DefaultUsuarioService.class);
